    ...
    <Fragment>
      ...
      <OrderListWrapper>
        <div>
          <OrderItemWrapper>
            {
              state.fetchState === REQUEST_STATE.LOADING ?    // APIロード中はローディングアイコン
                <CircularProgress />
              :
              state.lineFoodsSummary &&   // lineFoodsSummary => useEffectで定義(line_food_ids,　restaurant,　count,　amount)
              <OrderDetailItem 
          ...
          <div>
            { // 注文確定ボタン
              ...
              <OrderButton
                ...
                // リクエスト後(LOAD中/実行完了)はbuttonをdisabledに
